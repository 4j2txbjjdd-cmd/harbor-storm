...
`315 passed, 47 skipped` and the emulator suite `362 passed` with none
...
## 16b. Test suite
- **claim** 315 passing, and the 47 skips are one deliberate cause.
- **action** `.venv/bin/python -m pytest tests -q`
- **visible** `315 passed, 47 skipped` (`258` at the 2026-08-28 recheck, before the additive sentinel and ReliefRun)
