...
| Unregistered destination **denied** | not in the Agent Registry → refused, with no registry attribution in Google's log | same pair — *"not registered in the Agent Registry"* | COMMITTED |
